...
class SingleBoughtBill extends StatelessWidget {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          ...
          create: (context) => getIt<SingleBoughtInvoiceWatcherBloc>()
            ..add(SingleBoughtInvoiceWatcherEvent.initialized(
                m.optionOf(boughtBillBoughtOption))),
            ...
            builder: (context, state) {
              return Stack(children: <Widget>[
                WillPopScope(
                  onWillPop: () async {
                    bool? result =
                        await AutoRouter.of(context).replace(SignInPageRoute());
                    if (result == null) {
                      result = false;
                    }
                    return result;
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          if (context
                              ...
                              .getOrCrash()) {
                            isApproved = false;
                            BlocProvider.of<SingleBoughtInvoiceWatcherBloc>(
                                    context)
                                .add(SingleBoughtInvoiceWatcherEvent
                                    .isApprovedChanged(isApproved));
                            BlocProvider.of<SingleBoughtInvoiceWatcherBloc>(
                                    context)
                                .add(SingleBoughtInvoiceWatcherEvent.updated());
                          } else {
                            isApproved = true;
