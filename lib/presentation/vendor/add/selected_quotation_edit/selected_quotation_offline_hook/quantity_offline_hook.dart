...
class QuantityOfflineHook extends HookWidget {
  final Sold? bill;
  final int? quotationIndex;
  const QuantityOfflineHook({this.quotationIndex, Key? key, this.bill})
      : super(key: key);
    ...
    return BlocListener<SelectedWatcherBloc, SelectedWatcherState>(
        ...
        child: Padding(
            ...
            child: TextFormField(
              ...
              maxLength: QuotationQuantity.maxLength,
              ...
              onChanged: (value) {
                return context.watch<SelectedWatcherBloc>().add(
                    SelectedWatcherEvent.quantityChanged(
                        billQuotations:
                            List3Sold(this.bill!.quotations.getOrCrash()),
                        billQUotationQuantity: num.tryParse(value)!,
                        entry: this
                            .bill!
                            .quotations
                            .getOrCrash()
              ...
              /* onChanged: (value) => context
                  ...
                  state.copyWith(
                    bill: state.bill.copyWith(
                      quotations[quotationIndex].quantity: num.tryParse(value)
                    ),
                  ) */
