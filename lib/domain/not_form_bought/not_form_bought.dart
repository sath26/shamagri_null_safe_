...
// import 'package:shamagri_latest_flutter_version/domain/Boughts/todo_item.dart';
// import 'package:shamagri_latest_flutter_version/domain/Boughts/value_objects.dart';
...
part 'not_form_bought.freezed.dart';

@freezed
abstract class BoughtNotForm implements _$BoughtNotForm {
  const BoughtNotForm._();

  const factory BoughtNotForm({
    ...
    @required BoughtApproved? isApproved,
  }) = _BoughtNotForm;

  factory BoughtNotForm.empty() => BoughtNotForm(
        id: UniqueId(),
        total: BoughtTotalHere(1),
        buyerEmail: EmailAddressBought(''),
        // body: BoughtBody(''),
        // color: BoughtColor(BoughtColor.predefinedColors[0]),
        ...
        isApproved: BoughtApproved(false),
      );
