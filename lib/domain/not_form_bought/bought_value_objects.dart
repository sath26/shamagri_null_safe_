...
class BoughtApproved extends ValueObject<bool> {
  @override
  final Either<ValueFailure<bool>, bool> value;

  factory BoughtApproved(bool input) {
    assert(input != null);
    return BoughtApproved._(validateBool(input));
  }

  const BoughtApproved._(this.value);
}
